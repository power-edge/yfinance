...
EQUITY_SCREENER_EQ_MAP = {
    ...
    "exchanges": {"NMS", "NAS", "YHD", "NYQ", "NGM", "NCM", "BSE"},
    "peer_group": {
...
EQUITY_SCREENER_FIELDS = {
    "eq_fields": {"region", "sector", "peer_group", "exchanges"},
    "price": {
        "eodprice",
        "intradaypricechange",
...
PREDEFINED_SCREENER_BODY_MAP = {
    ...
    "undervalued_growth_stocks": {
        ...
        "query": {
            ...
            "operands": [
                ...
                {
                    "operator": "or",
                    "operands": [{"operator": "LT", "operands": ["pegratio_5y", 1]}],
                },
                {
                    "operator": "or",
                    "operands": [
            ...
            "operands": [
                {
                    ...
                    "operands": [
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Foreign Large Value"],
                        },
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Foreign Large Blend"],
                        },
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Foreign Large Growth"],
                        },
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Foreign Small/Mid Growth"],
                        },
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Foreign Large Blend"],
                        ...
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Foreign Small/Mid Blend"],
                        },
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Foreign Small/Mid Value"],
                        },
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Foreign Small/Mid Blend"],
                ...
                },
                {
                    "operator": "or",
                    "operands": [
                        {"operator": "EQ", "operands": ["performanceratingoverall", 4]},
                        {"operator": "EQ", "operands": ["performanceratingoverall", 5]},
                    ],
                },
                {"operator": "lt", "operands": ["initialinvestment", 100001]},
                {"operator": "lt", "operands": ["annualreturnnavy1categoryrank", 50]},
                {
                    "operator": "or",
                    "operands": [
                        {"operator": "EQ", "operands": ["riskratingoverall", 1]},
                        {"operator": "EQ", "operands": ["riskratingoverall", 3]},
                        {"operator": "EQ", "operands": ["riskratingoverall", 2]},
                    ],
                },
                {
                    "operator": "or",
            ...
            "operands": [
                ...
                },
                {
                    ...
                    "operands": [
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "High Yield Bond"],
                        }
                    ],
                },
                {
            ...
            "operands": [
                {
                    ...
                    "operands": [
                        {
                            "operator": "EQ",
                            "operands": ["categoryname", "Mid-Cap Growth"],
                        }
                    ],
                },
                {
    ...
    "top_mutual_funds": {
        ...
        "query": {
            "operator": "and",
            "operands": [
                {"operator": "gt", "operands": ["intradayprice", 15]},
                {
                    "operator": "or",
                    "operands": [
                        {"operator": "EQ", "operands": ["performanceratingoverall", 5]},
                ...
                {"operator": "gt", "operands": ["initialinvestment", 1000]},
                {
                    "operator": "or",
                    "operands": [{"operator": "eq", "operands": ["exchange", "NAS"]}],
                },
